...
insert into tree (member_id, size, theme, background) values
                                                          (1, 3, 'SNOWY', 'SILENT_NIGHT'),
                                                          (2, 10, 'SNOWY', 'SILENT_NIGHT');

insert into ornament (ornament_id, member_id, name, category, img_url, is_deleted, created_at, modified_at)
values (1, 1, 'name', 'CHRISTMAS', 'https://treetory.s3.ap-northeast-2.amazonaws.com/members/b8a3eb59-b956-4df9-8a55-80784016b8d4/ornaments/dc8f6be5-9103-4122-bd4a-0d0fe1da3f41:upload_2025-12-09-15.42.02.png', false, current_timestamp, current_timestamp);
...
values (1, 1, 1, 1, 1, 'message', 'nickni', 'NANUM_PEN', false, current_timestamp, current_timestamp),
       (2, 2, 1, 10, 10, 'message', 'nickni', 'NANUM_PEN', false, current_timestamp, current_timestamp);